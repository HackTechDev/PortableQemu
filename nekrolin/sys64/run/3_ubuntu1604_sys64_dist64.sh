...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/lib:/media/$currentuser/nekrolin/sys64/distribution/ubuntu1604_64/lib/ ../distribution/ubuntu1604_64/bin/qemu-system-x86_64  -enable-kvm -k fr -m 1024 -sdl -soundhw hda,ac97 -vga std \
