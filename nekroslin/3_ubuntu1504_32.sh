...
LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usr/local/lib:/media/$currentuser/nekros/ubuntu1504_32/lib/ ~/qemu/ubuntu1504_32/bin/qemu-system-i386 -enable-kvm -k fr -m 1024 -sdl -soundhw hda,ac97 -vga std \
